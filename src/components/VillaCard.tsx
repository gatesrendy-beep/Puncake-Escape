    ...
    >
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-4">
        ...
        <div>
          ...
          <div className="mt-3.5 pt-3 border-t border-stone-100 grid grid-cols-3 gap-2 text-center text-xs text-stone-600">
        ...
        <div className="pt-3 border-t border-stone-100">
          ...
          <div className="flex items-end justify-between mb-3">
              ...
              {hasDatesSelected ? (
                <>
                  <div className="text-[11px] text-emerald-700 font-semibold flex items-center gap-1">
                    <span>Estimasi Total ({nights} Malam):</span>
                  </div>
                  <div className="text-lg sm:text-xl font-bold text-stone-900">
                    {formatRupiah(total)}
                  </div>
                  <div className="text-[11px] text-stone-400">
                    Mulai {formatRupiah(villa.pricePerNightWeekday)} /malam weekdays
                  </div>
                </>
              ) : (
                <>
            ...
            <button
              ...
              className="text-xs font-semibold text-emerald-700 hover:text-emerald-800 flex items-center gap-1 p-1 hover:underline"
            >
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-xl bg-emerald-700 hover:bg-emerald-600 active:scale-[0.98] text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-xs transition-all"
          >
