...
export function Footer({ onSelectArea, onFilterHeated, onFilterFamily, onOpenAdmin }: FooterProps) {
  return (
          ...
          <div className="flex items-center gap-4 text-stone-400">
            ...
            {onOpenAdmin ? (
              <button
                type="button"
                onClick={onOpenAdmin}
                className="text-stone-500 hover:text-emerald-400 transition-colors inline-flex items-center gap-1 font-medium"
              >
